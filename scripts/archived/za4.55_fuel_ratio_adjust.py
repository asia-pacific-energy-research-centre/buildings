...
df_ratios = pd.read_csv(config.root_dir + '/output_data/a4_fuel_split_by_end_use/ratios.csv')
# %%
output_dir_csv = config.root_dir + '/output_data/a4.55_ratio_adjust/' 
...
# %%
output_dir_fig = config.root_dir + '/plotting_output/a4.55_ratio_adjust/adjusted_ratios/'
