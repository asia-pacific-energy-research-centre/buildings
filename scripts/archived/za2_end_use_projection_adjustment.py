...
# %%
from scripts.x2_useful_functions import generate_smooth_curve

# %%
end_use_trajectory1 = pd.read_csv(config.root_dir + '/output_data/a1_projection/projection_w_end_use_scaled.csv')
...
def traj(economy='01_AUS', 
    ...
    energy_refine_auto_csv = config.root_dir + '/output_data/a3_energy_refine_auto/{}/'.format(economy)
    ...
    energy_refine_auto_fig = config.root_dir + '/plotting_output/a3_energy_refine_auto/{}/'.format(economy)
