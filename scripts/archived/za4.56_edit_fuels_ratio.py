...
df_ratios = pd.read_csv(config.root_dir + '/output_data/a4.55_ratio_adjust/normalized_ratios_all_years.csv')
...
# %%
output_dir_csv = config.root_dir + '/output_data/a4.56_ratio_adjust/'
