...
# %%
# import file from b2 that has end use projections

end_use_projections = pd.read_csv(config.root_dir + '/output_data/b2_end_use_adjustment_apply/adjusted_end_use_compiled.csv')
eei = pd.read_csv(os.path.join(config.root_dir, 'input_data','eei', 'buildings_final.csv'))

# made in c1
df_ratios = pd.read_csv(config.root_dir + '/output_data/c1_create_df/df_created_fuels_enduses.csv')
...
output_dir_csv = config.root_dir + '/output_data/c2_fuel_split_for_end_use/'
