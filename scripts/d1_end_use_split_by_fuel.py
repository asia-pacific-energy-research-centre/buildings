...
ratios = pd.read_csv(config.root_dir + '/output_data/c4_ratio_adjust/norm_ratio_to_2100.csv')
...
# %%
end_use_projection = pd.read_csv(config.root_dir + '/output_data/b2_end_use_adjustment_apply/adjusted_end_use_compiled.csv')
...
output_dir_csv = config.root_dir + '/output_data/d1_end_use_split_by_fuel/'
...
output_dir_fig = config.root_dir + '/plotting_output/d1_end_use_split_by_fuel/'
